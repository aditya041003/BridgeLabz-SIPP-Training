...
class SavingsAccount extends BankAccount{
    ...
    @Override void displayAccountType(){ System.out.println("Savings Account Interest:"+interestRate+"%"); }
}
...
class FixedDepositAccount extends BankAccount{
    ...
    @Override void displayAccountType(){ System.out.println("Fixed Deposit Term:"+term+" months"); }
}
public class BankAccounts{
    public static void main(String[]args){
        ...
        for(BankAccount b: list) b.displayAccountType();
    }
}